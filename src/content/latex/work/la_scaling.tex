...
This post summarizes key findings made during the analysis of the scaiability of various learning algorithms, \emph{including} the ones that are not specifically related or relevant.

\subsection{Generating Data from an MLP}\label{generating-data-from-an-mlp}
