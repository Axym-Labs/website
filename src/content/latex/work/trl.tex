...
\section{Temporal Regularized Learning: Self-Supervised Learning Local In Space And Time}\label{temporal-regularized-learning-self-supervised-learning-local-in-space-and-time}

\publicationbadge
  {https://doi.org/10.5281/zenodo.17840254}
  {https://zenodo.org/badge/DOI/10.5281/zenodo.17840254.svg}
  {DOI}
\publicationbadge
  {https://www.researchgate.net/publication/398409613_Temporal_Regularized_Learning_Self-supervised_learning_local_in_space_and_time}
  {https://img.shields.io/badge/Read on-ResearchGate-00cc66.svg}
  {Read on ResearchGate}

\href{https://github.com/Axym-Labs/TRL}{Github Repository}
...
\subsubsection{Quickstart}\label{quickstart}

\begin{itemize}
\tightlist
\item
  Train a TRL model with \texttt{train.py}.
\item
  \texttt{trl/config/configurations.py} contains functions that modify the setup, e.g.~modify the model architecture.
\item
  The \texttt{previous\_versions} folder has a README with short explanations of what changed in each version.
\end{itemize}
